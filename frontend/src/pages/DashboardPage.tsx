...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-ink text-paper font-body">
      <nav className="max-w-4xl mx-auto flex items-center justify-between px-4 sm:px-6 py-6">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          ...
          <Link
            to="/interview/new"
            className="flex items-center justify-center gap-2 bg-spotlight text-ink font-semibold px-4 py-2.5 rounded-lg hover:bg-spotlight-soft transition-colors whitespace-nowrap"
          >
        ...
        <div className="space-y-3">
          {interviews.map((interview) => (
            <Link
              ...
              className="flex items-center justify-between gap-3 bg-ink-soft border border-ink-line rounded-xl px-5 py-4 hover:border-spotlight/30 transition-colors"
            >
              <div className="min-w-0">
                <h3 className="font-display font-semibold truncate">{interview.jobRole}</h3>
                <p className="text-sm text-paper-muted truncate">{interview.techStack} · {interview.difficulty}</p>
              </div>
